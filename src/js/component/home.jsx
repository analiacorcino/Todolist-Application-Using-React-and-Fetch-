  ...
  return (
    <div className="container m-5">
      <div className="card p-5">
          ...
          {listaDeTareas.map((tarea, i) => {
            return (
              <li className="list-group-item border border-1 tareaOculta" key={i}>
                {tarea}
                <span className="close" onClick={() => eliminarTarea(i)}>
                  x
                </span>
              </li>
            );
        ...
        <div className="alert alert-primary mt-5">{listaDeTareas.length == 0 ? "No hay tareas, añadir tareas" : "Numero de tareas: "+listaDeTareas.length}
